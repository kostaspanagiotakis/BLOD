#!/bin/bash
#SBATCH --job-name=bregman_1d_gpu
...
#SBATCH --output=logs/bregman_gmm_%j.out
#SBATCH --error=logs/bregman_gmm_%j.err
...
srun --ntasks=1 --gres=gpu:1 python -u scripts/run_bregman_gmm.py