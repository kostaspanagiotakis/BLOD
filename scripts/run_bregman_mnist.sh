...
#SBATCH --output=logs/bregman_mnist%j.out
#SBATCH --error=logs/bregman_mnist%j.err
...
echo "=== launching MNIST experiment ==="
srun --ntasks=1 --gres=gpu:1 python -u scripts/run_bregman_mnist.py