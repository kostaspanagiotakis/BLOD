...
from mi.experiments import run_experiment
from mi.plots import plot_mi_vs_dimension, ensure_dir
...
def main():
    ...
    # ------------------------------------------------------------
    final_plot_path = os.path.join(output_dir, "mi_vs_dimension.png")
