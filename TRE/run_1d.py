from gaussian_ratio import run_experiment, compare_average_thetas, print_bridge_means
...
def main():
    ...
    bridge_width = 6.0
    n_grid = 3000
    n_inner_mc = 64   # Monte Carlo samples for the conditional A-term in BLOD
